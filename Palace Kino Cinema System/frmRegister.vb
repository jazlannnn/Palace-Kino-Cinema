...
Public Class frmRegister
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Dim objcon As SqlConnection = New SqlConnection("Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\User\Documents\GitHub\Palace-Kino-Cinema-System\Palace Kino Cinema System\PalceKinoSystemDb.mdf;Integrated Security=True")
        objcon.Open()
