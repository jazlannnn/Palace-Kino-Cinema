...
Public Class frmBookingPage
    ...
    Private Sub grpBoxTypeTicket_Enter(sender As Object, e As EventArgs) Handles grpBoxTypeTicket.Enter
    ...
    Private Sub lblSeniorPrice_Click(sender As Object, e As EventArgs) Handles lblSeniorPrice.Click
