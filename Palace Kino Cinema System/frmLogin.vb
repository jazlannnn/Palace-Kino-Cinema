...
Public Class frmLogin
    Private Sub btnLogin_Click(sender As Object, e As EventArgs) Handles btnLogin.Click
        ...
        con = New SqlConnection("Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\User\Documents\GitHub\Palace-Kino-Cinema-System\Palace Kino Cinema System\PalceKinoSystemDb.mdf;Integrated Security=True")
        con.Open()
